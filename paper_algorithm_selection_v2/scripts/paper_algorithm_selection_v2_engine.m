function summary = paper_algorithm_selection_v2_engine(packageRoot)
%PAPER_ALGORITHM_SELECTION_V2_ENGINE Recalibrated O1 selection campaign.
...
save(fullfile(cfg.rawDir, "paper_algorithm_selection_v2_workspace.mat"), ...
...
cfg.frozenRowsPath = fullfile(repoRoot, "paper_verification_v12", ...
    "results", "raw", "factorial_rows.csv");
cfg.frozenDynamicPath = fullfile(repoRoot, "paper_verification_v12", ...
...
writetable(metrics, fullfile(cfg.root, ...
    "result_metrics_algorithm_selection_v2.csv"));
