%% Audit Paper Verification v1.2 recalibrated evidence.
...
metricsPath = fullfile(packageRoot, "result_metrics_paper_v12.csv");
...
requiredFigures = "fig_pv12_" + compose("%02d", (1:10).') + [
    "_factorial_C.png"
    "_factorial_ESR.png"
...
auditPath = fullfile(packageRoot, "logs", ...
    "audit_paper_verification_v12.txt");
...
fprintf("Paper Verification v1.2 audit PASS.\n");
