...
- Final architecture decision: **PRIMARY_TS_SRKE**; primary manuscript realization: **selection unresolved**; extension: **selection unresolved**.
...
- Static C/ESR mean MAPE (M1/M2/M3): 0.3727/0.3011/0.3043% and 0.2233/0.6446/1.1938%.
