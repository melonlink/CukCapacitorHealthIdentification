...
11. **Primary realization?** `selection unresolved` for the first manuscript; overall decision token `PRIMARY_TS_SRKE`.
12. **Role of the other estimator?** `selection unresolved` is the uncertainty-aware health-reporting extension; Dual EKF remains a third reference.
