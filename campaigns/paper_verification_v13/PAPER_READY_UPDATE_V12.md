...
- E1 RLS: C MAPE 0.3727%, ESR MAPE 0.2233%, p95 1.3265%/0.7015%, convergence 13.21 cycles.
- E2 Dual EKF: C MAPE 0.3043%, ESR MAPE 1.1938%, p95 1.1507%/3.8772%, convergence 40.58 cycles.
- E3 LTV/Joseph: C MAPE 0.3011%, ESR MAPE 0.6446%, p95 1.1173%/2.5166%, convergence 33.09 cycles.
- E4 TS-SRKE: C MAPE 0.3011%, ESR MAPE 0.6446%, p95 1.1173%/2.5166%, convergence 33.09 cycles.

## Blocking dynamic result

O1-E3 did not converge within 257 post-step cycles. Tail C tracking error after C->0.8C was 19.2911%; tail ESR tracking error after ESR->2R was 49.9384%. This triggers REOPEN_ALGORITHM.
