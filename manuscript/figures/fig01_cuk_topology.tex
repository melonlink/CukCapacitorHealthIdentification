...
\begin{tikzpicture}[american currents,american voltages,
  ...
  \node[font=\sffamily\small,anchor=west] at (-0.45,3.12)
  ...
  \node[font=\sffamily\small,anchor=west,stateblue] at (-0.45,-1.30)
    {(b) $u=0$: $i_C=+i_1$};
  ...
  \node[font=\sffamily\small,anchor=west,stateorange] at (5.30,-1.30)
    {(c) $u=1$: $i_C=-i_2$};
